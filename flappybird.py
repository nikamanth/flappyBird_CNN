...
FPS = 20
ANIMATION_SPEED = 0.18/4  # pixels per millisecond
WIN_WIDTH = 71 * 2     # BG image size: 284x512 px; tiled twice
WIN_HEIGHT = 128
...
def main():
    ...
    while not done:
        ...
        # print pygame.display.get_surface().get_at((100,100))
        print pygame.surfarray.array3d(pygame.display.get_surface()).shape
        # print n.shape

        # print pygame.display.get_surface().get_rect()
